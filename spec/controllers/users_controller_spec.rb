  ...
  describe "GET 'new'" do
	...
	describe "POST 'create'" do
		...
		describe "success" do
			...
			before(:each) do
				@attr = { :name => "new user", :email => "email@exmaple.com",
	...
	describe "GET 'index'" do
		...
		describe "for signed-in users" do
			...
			before(:each) do
				...
				second = create(:user, :email => "second@example.com")
				third = create(:user, :email => "third@example.com")
	...
	describe "DELETE 'destroy'" do
		...
		describe "as a non-admin user" do
			...
			it "should not have link to destroy user" do
				get :index
		...
		describe "as an admin user" do
			...
			it "should have link to destroy user" do
				get :index
